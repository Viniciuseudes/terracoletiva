...
import { Sprout, Home, Search, TrendingUp, User, Menu } from "lucide-react"
import { Sheet, SheetContent, SheetTrigger } from "@/components/ui/sheet"
import { cn } from "@/lib/utils"

const navItems = [
  { href: "/vendedor", label: "Início", icon: Home },
  { href: "/vendedor/buscar", label: "Buscar Cotas", icon: Search },
  { href: "/vendedor/propostas", label: "Propostas", icon: TrendingUp },
